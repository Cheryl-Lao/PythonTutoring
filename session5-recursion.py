...
class tictactoe_board():
    ...
    #TODO Write a function that checks if X or O won on a board. Take the character in as a parameter and return true or false
...
# memoization to avoid the repetitions later
